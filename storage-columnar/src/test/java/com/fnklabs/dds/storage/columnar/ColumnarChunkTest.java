...
public class ColumnarChunkTest {

    private ColumnarChunk columnarChunk;
    ...
    public void setUp() throws Exception {
        ...
        columnarChunk = new ColumnarChunk(
                "test",
                Arrays.asList(
                        idColumn,
                        createdAtColumn,
                ...
                64 * 1024 * 1024,
                Range.open(Long.MIN_VALUE, Long.MAX_VALUE),
                1,
    ...
    @Test
    public void size() {
        Assert.assertEquals(64 * 1024 * 1024, columnarChunk.size());
    }

    @Test
    public void maxSize() {
        Assert.assertEquals(64 * 1024 * 1024, columnarChunk.maxSize());
    }
