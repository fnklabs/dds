...
public class SingleNodeExample {
    public static void main(String[] args) {
        ...
        HashSet<HostAndPort> members = Sets.newHashSet(firstNode);


        try {
            TestNodeFactory nodeFactory = new TestNodeFactory(listeningExecutorService, listeningScheduledExecutorService, firstNode);
            Ring ring = new Ring(members, firstNode, nodeFactory, "TestLocal");

            LocalNode node = (LocalNode) nodeFactory.get(firstNode);
    ...
    protected static ListeningScheduledExecutorService getScheduledExecutorService() {
        ...
        threadPoolTaskScheduler.initialize();
        threadPoolTaskScheduler.setErrorHandler(t -> LoggerFactory.getLogger(SingleNodeExample.class).warn("Execution exception", t));
